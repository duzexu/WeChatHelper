...
- (id)getTaskWithVideoPath:(id)arg1;
...
- (id)startNewTaskForInputPath:(id)arg1 outputPath:(id)arg2 params:(id)arg3 isHighPriority:(_Bool)arg4 completionBlock:(CDUnknownBlockType)arg5;
