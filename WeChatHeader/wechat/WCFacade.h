...
@class MyWCDB, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCAdvertiseCommentUploadMgr, WCAdvertiseDataHelper, WCAdvertiseLogicMgr, WCBGImgLogic, WCBGRecommendMgr, WCBrowseInfo, WCCanvasTypeMgr, WCCommentUploadMgr, WCDataItem, WCDownloadMgr, WCGroupMgr, WCInputTextCacheMgr, WCLogicMgr, WCNotificationCenterMgr, WCOperationSetting, WCPatternCacheMgr, WCPreloadLogicMgr, WCSnsABTestMgr, WCSnsLocalCacheMgr, WCStrangerCommentMgr, WCTimelineMgr, WCUploadMgr;
