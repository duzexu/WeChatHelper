...
@class ABTestItem, LocationRetriever, NSCache, NSString, UIView, WCPayAddPayCardLogic, WCPayAvaliablePayCardListView, WCPayGenDigitalCertCgi, WCPayOverseasCardTipView;
