...
@class MMProgressViewEx, MMTimer, MMUIButton, MMUILabel, MMVideoPlayerCore, MMWebImageView, NSString, UIButton, UILabel, WAVideoLayer, WAWebViewController, WCNetworkMediaCore, WCNetworkMediaSlider;
