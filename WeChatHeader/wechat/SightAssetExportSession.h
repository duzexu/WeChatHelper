...
@class AVAsset, AVAssetReader, AVAssetReaderAudioMixOutput, AVAssetReaderVideoCompositionOutput, AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, AVMutableComposition, AVVideoComposition, NSDictionary, NSError, NSObject<OS_dispatch_queue>, NSString, NSURL;
...
@property(retain, nonatomic) AVMutableComposition *assetComposition; // @synthesize assetComposition=_assetComposition;
